...
def spam_start(phone, cycles, lang, time_while):
	...
	time.sleep(10)
	try:
		spam_request = requests.post("http://127.0.0.1:8080/attack/start", json={
	...
	link_check_status = "http://127.0.0.1:8080/attack/" + resp_id + "/status"
	if resp_status:
		spam_work = True
		temp_int_stat = 0
		if lang == "EN":
...
if lang == "EN":
	...
	spam_start(phone, cycles, lang, time_while)
elif lang == "UA":
